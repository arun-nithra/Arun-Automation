	   ...
	   // private void fillRegistrationForm() {
	        try {
				...
				WebElement titleDropdown =driver.findElement(
		               By.xpath("//*[@id=\"mat-select-0\"]/div/div[2]/div/svg"));
	        	titleDropdown.click();
	        	Thread.sleep(10000);
	        	...
	        	WebElement titleName=driver.findElement(By.xpath("//mat-option[@id='mat-option-4']"));
	        	 titleName.click();
	            // Fill First Name
